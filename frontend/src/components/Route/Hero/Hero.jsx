...
const Hero = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url(https://lh3.googleusercontent.com/u/0/drive-viewer/AEYmBYQsSvikRIpG73Ov6xF_5DLUhx5YpLe9XzEM4gNSeucHzcPJ-GQMeP-_Kcmms3nQ-_5270TADd92RdnO3V6RForCPAEh=w1920-h948)",
      }}
    >
